...
namespace MLTD.Extensions
{
    public static class StreamExtensions
    {

        /// <summary>
        /// Reads the rest of the stream, starting from the stream's current position.
        /// </summary>
        ...
        public static int Write(this Stream stream, int value)
        {
            ...
            {
                value = TheaterHelper.SwapEndian(value);
            }
        ...
        {
            WriteZeroEndedString(stream, value, MltdConstants.Utf8WithoutBom);
        }
