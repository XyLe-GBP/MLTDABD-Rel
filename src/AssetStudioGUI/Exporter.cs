    ...
    internal static class Exporter
    {
        public static bool ExportTexture2D(AssetItem item, string exportPathName)
        {
            ...
            if (Settings.Default.convertTexture)
            {
                ...
                var ext = Settings.Default.convertType;
                bool tga = false;
                switch (ext)
                {
                    case "BMP":
        ...
        public static bool ExportAudioClip(AssetItem item, string exportPath)
        {
            ...
            if (Settings.Default.convertAudio && converter.IsSupport)
            {
        ...
        {
            var eulerFilter = Settings.Default.eulerFilter;
            var filterPrecision = (float)Settings.Default.filterPrecision;
            var exportAllNodes = Settings.Default.exportAllNodes;
            var exportSkins = Settings.Default.exportSkins;
            var exportAnimations = Settings.Default.exportAnimations;
            var exportBlendShape = Settings.Default.exportBlendShape;
            var castToBone = Settings.Default.castToBone;
            var boneSize = (int)Settings.Default.boneSize;
            var scaleFactor = (float)Settings.Default.scaleFactor;
            var fbxVersion = Settings.Default.fbxVersion;
            var fbxFormat = Settings.Default.fbxFormat;
