...
{
    public partial class AssetStudioGUIForm : Form
    {
        ...
        public AssetStudioGUIForm()
        {
            ...
            displayAll.Checked = Settings.Default.displayAll;
            displayInfo.Checked = Settings.Default.displayInfo;
            enablePreview.Checked = Settings.Default.enablePreview;
            FMODinit();
        ...
        {
            Settings.Default.displayAll = displayAll.Checked;
