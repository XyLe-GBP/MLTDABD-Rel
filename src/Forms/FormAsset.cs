...
namespace MLTDABD.Forms
{
    public partial class FormAsset : Form
    {
        ...
        public FormAsset([NotNull] AssetInfoList manifest, [NotNull] ManifestOpening opening, [CanBeNull] DownloadConfig downloadConfig)
        {
            Manifest = manifest;
            _opening = opening;
        ...
        private void InitializeControls()
        {
...

            {
                ...
                {
                    formTitle = $"Remote: {opening.Version}";
                    ...
                    var mobilePlatform = config?.Platform ?? UMPF.Unknown;
